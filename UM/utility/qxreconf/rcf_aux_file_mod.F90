...
!-------------------------------------------------------------------
!print *, "jhan:AUX:Hdr_Aux % IntC( IC_XLen ) ", Hdr_Aux % IntC( IC_XLen )  
!print *, "jhan:AUX:Hdr_Out % IntC( IC_XLen ) ", Hdr_Out % IntC( IC_XLen )
!print *, "jhan:AUX:Hdr_Aux % IntC( IC_YLen ) ", Hdr_Aux % IntC( IC_YLen )  
!print *, "jhan:AUX:Hdr_Out % IntC( IC_YLen ) ", Hdr_Out % IntC( IC_YLen ) 
!if(Hdr_Out % IntC( IC_YLen ) ==144)  Hdr_Out % IntC( IC_YLen ) =145
