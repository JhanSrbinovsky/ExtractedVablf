...
!   in the scaling.
  ...
  ELSE IF (i_fnc == ip_scale_wenyi) THEN
    ...
    IF (i_band  ==  4) THEN
!print *,"jhan:n_layer ",n_layer
!print *,"jhan:n_profile",n_layer
!print *,"jhan:iex",iex
!print *,"jhan:gk41",gk4(15,16,iex)
!print *,"jhan:gas_frac_rescaled",gas_frac_rescaled 
      DO i=i_top, n_layer
        DO l=1, n_profile
...
!print *,"jhan:jp ",jp
!print *,"jhan:jp1 ",jp1
!print *,"jhan:gk4 ",gk4(jt,jp,iex)
!print *,"jhan:gk41 ",gk4(jt,jp1,iex)
!print *,"jhan:cgp ",cgp
!print *,"jhan:plg ",plg(jp)
